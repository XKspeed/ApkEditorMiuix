...
fun App(service: ApkDataService? = null) {
    ...
    var floatingNavigationBar by remember { mutableStateOf(false) }

    // 创建模糊背景层
    val backdrop = rememberBlurBackdrop(blurEnabled = blurEnabled)
    ...
    Scaffold(
        ...
        bottomBar = {
            BlurredBar(backdrop = backdrop, blurEnabled = blurEnabled) {
        ...
        Box(
            ...
            when (tab) {
                ...
                2 -> SettingsScreen(
                    ...
                    onFloatingNavigationBarChange = { floatingNavigationBar = it },
                )
            }
        }
    }
